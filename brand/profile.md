# @CryptoRelicDay — профиль и стартовый контент

## Поля профиля

- **Display name:** `Crypto Relic Day`
- **Bio (до 160 символов):**
  ```
...
## Твит №3 — provably fair объяснение

```
"Provably fair" usually means "trust our RNG".
...
```
⛓️ Day {N}. Block #{HEIGHT} is sealed.
...
1. Ежедневный пост — строго в одно время (совет: 15:00 UTC — утро США + вечер Европы).
2. 30–60 минут в день отвечать под крупными крипто/гейминг-аккаунтами (не ссылкой, а по делу; ссылка — в профиле).
3. Каждый редкий дроп юзера — репост с комментарием. Каждый скрин в реплаях — лайк+ответ.
4. Не постить ссылку чаще 1 раза в день. Новый аккаунт за спам ссылками улетает в теневой бан мгновенно.
5. Никаких купленных подписчиков и фоллов-анфоллов.
